...
public class TeletextList
{
    ...
    public TeletextList(String[] headlines)
    {
        ...
        heading.getNext().setNext(heading.getPrevious());
        heading.getPrevious().setPrevious(heading.getNext());

        topNode = heading;

        ListNode2<String> node = heading;
        current = heading.getNext();
        for ( String headline : headlines )
        {
            current = addAfter( current, headline );
        }
        current.setNext(heading.getPrevious());
        heading.getPrevious().setPrevious(current);
    ...
    public void insert(String msg)
    {
        ...
        heading.getNext().setNext(new ListNode2<String>(msg, heading.getNext(), next));
    }
    ...
    public void delete()
    {
        if ( topNode != heading && topNode != heading.getNext() && topNode != heading.getPrevious() )
        {
    ...
    {
        ListNode2<String> sigmaNode = new ListNode2<String>(msg, node, node.getNext());
        node.setNext(sigmaNode);
        sigmaNode.getNext().setPrevious(sigmaNode);
        return sigmaNode; //fix this
    }
