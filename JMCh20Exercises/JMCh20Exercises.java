...
public class JMCh20Exercises<E>
{
    ...
    {
        return !Objects.isNull(head) && !Objects.isNull(head.getNext());
    }
    ...
    public ListNode<E> add( ListNode<E> head, E value )
    {
        ...
        node.setNext(new ListNode<E>(value, null));
    ...
    public ListNode<E> reverseList( ListNode<E> head )
    {
        ...
        for (int i = list.size() - 1; i >= 0; i--) {
            newNode = new ListNode<E>(list.get(list.size() - i - 1), newHead);
            newHead = newNode;
        }
    ...
    public ListNode<String> concatenateStrings( ListNode<String> head )
    {
        ...
        ListNode<String> newNode, newHead = new ListNode<String>(null, null);
        newHead.setValue(str);
        newNode = newHead;
        head = head.getNext();

        while (head != null) {
            str += head.getValue();
            newNode.setNext(new ListNode<String>(str, null));
    ...
    public ListNode<String> insertInOrder( ListNode<String> head, String s )
    {
        ...
        if (head.getValue().compareTo(s) > 0) {
            head = new ListNode<String>(s, head);
            return head;
        }

        while (node.getNext() != null && node.getNext().getValue().compareTo(s) < 0) {
            node = node.getNext();
        }

        if (node.getNext() != null && node.getNext().getValue().equals(s)) {
            return head;
        }

        ListNode<String> newNode = new ListNode<String>(s, node.getNext());
    ...
    {
        ArrayList<ListNode<E>> list = new ArrayList<ListNode<E>>();
    ...
    public static void sort( ListNode<String> head )
    {
        ...
        node = head;
        while (node.getNext() != null) {
            ListNode<String> min = node;
            ListNode<String> thing = node;
            while (thing != null) {
                if (thing.getValue().compareTo(min.getValue()) < 0) {
                    min = thing;
                }
                thing = thing.getNext();
            }
