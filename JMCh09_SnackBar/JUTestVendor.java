...
public class JUTestVendor
{
    ...
    public void testVendorConstructor()
    {
        ...
        assertEquals(0.0, machine1.getTotalSales(), 0);
    ...
    {
        double currentTotal = machine1.getTotalSales();
        machine1.setStock(0);
        ...
        assertEquals(currentTotal, machine1.getTotalSales(), 0);
    ...
    public void testmakeSaleNoChange()
    {
        ...
        assertEquals(ITEM_COST * 0.01, machine1.getTotalSales(), 0);
        //System.out.println("testmakeSaleNoChange - " + machine1);
    }
    ...
    public void testmakeSaleX3()
    {
        ...
        assertEquals((numSales-1) * ITEM_COST * 0.01, machine1.getTotalSales(), 0);
        //System.out.println("testmakeSaleX3 - " + machine1);
    }
